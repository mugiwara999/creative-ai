...
const About = () => {
  ...
  return (
    <section id="about" className="py-16 bg-zinc-950 relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <span className="text-[#BFFF00] text-xs font-semibold tracking-wider uppercase">
              About Me
            </span>
          ...
          <div className="flex justify-center mb-8">
            <div className="relative group">
              ...
              <img
                ...
                className="relative w-28 h-28 md:w-32 md:h-32 rounded-full object-cover border-4 border-[#BFFF00]/30 group-hover:border-[#BFFF00]/60 transition-all duration-300 shadow-lg shadow-[#BFFF00]/20"
              />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            <div 
              ...
              className="bg-zinc-900/50 p-5 rounded-lg border border-[#BFFF00]/10 hover:border-[#BFFF00]/30 transition-all duration-300 group cursor-pointer hover:scale-105"
            >
              <div className="bg-[#BFFF00]/10 w-10 h-10 rounded-lg flex items-center justify-center mb-3 group-hover:bg-[#BFFF00]/20 transition-colors duration-300">
                <User className="text-[#BFFF00]" size={20} />
              </div>
              <h3 className="text-white font-bold text-base mb-2">Who I Am</h3>
            ...
            >
              <div className="bg-[#BFFF00]/10 w-10 h-10 rounded-lg flex items-center justify-center mb-3 group-hover:bg-[#BFFF00]/20 transition-colors duration-300">
                <Target className="text-[#BFFF00]" size={20} />
              </div>
              <h3 className="text-white font-bold text-base mb-2">What I Do</h3>
              <p className="text-white/60 leading-relaxed text-sm">
            ...
            >
              <div className="bg-[#BFFF00]/10 w-10 h-10 rounded-lg flex items-center justify-center mb-3 group-hover:bg-[#BFFF00]/20 transition-colors duration-300">
                <Zap className="text-[#BFFF00]" size={20} />
              </div>
              <h3 className="text-white font-bold text-base mb-2">Why Choose Me</h3>
              <p className="text-white/60 leading-relaxed text-sm">
          ...
          {/* Stats */}
          <div ref={statsRef} className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto items-center">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-[#BFFF00] mb-1">
                {projectsCount}+
              </div>
            ...
            <div className="text-center">
              <button
                ...
                className="inline-flex items-center gap-2 bg-[#BFFF00] text-black font-bold px-5 py-3 text-sm rounded-lg hover:bg-[#a8e600] transition-all duration-300 animate-float group"
              >
                <svg 
